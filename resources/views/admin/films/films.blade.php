    ...
    <div class="card mt-4 shadow  mb-2 bg-body rounded">
        ...
        <div class="card-body">
            <div class="row">
                <div class="hstack gap-2 mb-3">
                    <div class="col me-auto">
                        <a href="{{ route('add-film') }}" type="button" class="button btn btn-success">
                    ...
                    <div class="col-3 ms-auto">
                        <form action="{{ route('films') }}" class="input-group input-group-sm">
                ...
                @if ($films->isNotEmpty())
                    @foreach ($films as $index => $film)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('detail-film', $film->id_film) }}"
                                   class=" btn btn-success btn-sm text-center" data-bs-toggle="tooltip"
                                   data-bs-placement="top" title="Views detail data">
                                    <svg
                                ...
                                <div class="btn-group btn-group-sm">
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end drop-menu"
                                            ...
                                            <li>
                                                <form action="{{ route("delete-film", $film->id_film) }}" method="POST">
                                                    @method('delete')
                                                    @csrf
                                                    <div class="row mx-auto">
                                                        <div class="col-5 ">
            ...
            @if (request('search'))
                ...
                <a href="{{ route('films') }}" type="button" class="button btn btn-primary">
                    <span class="button__icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                             viewBox="0 0 576 512">
                            <path
