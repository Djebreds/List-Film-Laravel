                    ...
                    {{-- <div class="col-6">
                        <div class='delete_status'>
                            ...
                            <div class='alert alert-success d-flex alert-dismissible fade show' role='alert'>
                                ...
                                <div>
                                    Production successfuly deleted <span class='ms-3'><b>note: Deleted data cannot
                                            recovery!</b></span>
                                </div>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end drop-menu"
                                        ...
                                        <li>
                                            <div class="row mx-auto">
                                                <div class="col-5 ">
                                                    <a href="update-production.php?id_production="
                                ...
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end drop-menu"
                                        ...
                                        <li>
                                            <div class="row mx-auto">
                                                <div class="col-5 ">
                                                    <a href="delete-production.php?id_production="
                                                        class="dropdown-item text-center text-danger px-2">Yes</a>
                                                </div>
                                                <div class="col-auto">
                                                    <div class="d-flex" style="height: 25px;">
