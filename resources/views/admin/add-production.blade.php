            ...
            <div class="card mt-4 border border-4 border-end-0 border-top-1 border-bottom-0 border-start-0 border-warning shadow  mb-2 bg-body rounded mx-auto"
                ...
                <div class="card-body">
                    ...
                    <div class='alert alert-success d-flex alert-dismissible fade show' role='alert'>
                        ...
                        <div>
                            Production successfuly to added <a href='productiontable-panel.php' class='alert-link'>See for
                                more</a>.
                        </div>
                        <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="m-4">
                                        ...
                                        <div class="col-sm-11">
                                            <input type="text" class="form-control form-control-sm" name="name_production"
                                                id="title" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-4">
                                    <div class="row m-4">
                                        ...
                                        <div class="col-6">
                                            <input type="date" class="form-control form-control-sm" name="founded_date"
                                                id="dates" required>
                                        </div>
                                    </div>
                                </div>
