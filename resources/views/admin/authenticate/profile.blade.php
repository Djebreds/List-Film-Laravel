...
@section('content')
    ...
    <div class="card p-1 mb-3 card shadow mb-2 bg-body rounded profile border-0">
        <div class="row p-1">
            <div class="hstack">
                <div class="col-1">
                    <img src="{{ URL::asset('assets/img/avatar.png') }}" class="rounded-circle">
                </div>
                <div class="col">
    ...
    <div
        class="card p-2 my-3 card shadow mb-2 bg-body rounded border-3 border-end-1 border-top-0 border-bottom-0 border-start-1 border-primary basic-info list-group-flush">
        ...
        <div class="row p-1">
            <div class="col">
                <div class="mb-3">
                    ...
                    <input type="name" class="form-control form-control-sm" id="name" value="{{ auth()->user()->name }}"
                        readonly>
                </div>
                <div class="mb-3">
            ...
            <div class="col">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm" id="role" value="{{ auth()->user()->role }}"
                        readonly>
                </div>
                <div class="mb-3">
                    <label for="joined" class="form-label">Joined</label>
                    <input type="text" class="form-control form-control-sm" id="joined"
                        value="{{ date('d-m-Y H:m:s', strtotime(auth()->user()->created_at)) }}" readonly>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control form-control-sm" id="password" name="password" value=""
                            placeholder="Leave it blank if you do not want to change">
                    </div>
                    <div class="mb-3">
                        <label for="password-repeat" class="form-label">Confirm Password</label>
                        <input type="password" class="form-control form-control-sm" id="password"
                            name="password_confirmation" placeholder="Leave it blank if you do not want to change" value="">
                    </div>
                </div>
