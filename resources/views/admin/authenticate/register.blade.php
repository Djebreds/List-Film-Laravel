...
@section('content')
        <div class="container">
            <h4 class="text-center text-white" style="margin-top: 5rem">Hello. Want to be admin on our website ?</h4>
                            ...
                            <div class="col-lg-7 col-md-6">
                                <form action="{{ route('register') }}" method="POST">
                                    ...
                                    <div class="mb-2 inner-addon left-addon">
                                        ...
                                        <input type="text" class="form-control form-control-sm rounded-pill  @error('name') is-invalid @enderror" autocomplete="username"
                                            name="username" id="username" value="{{ old('name') }}" required>
                                        @error('name')
                                    ...
                                    <div class="mb-2 inner-addon left-addon">
                                        ...
                                        <input type="email" class="form-control form-control-sm rounded-pill @error('email') is-invalid @enderror"
                                            name="email" id="email" value="" autocomplete="email" required>
                                        @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                                        </span>
                                    ...
                                    <div class="mb-2 inner-addon left-addon">
                                        ...
                                        <input type="password" class="form-control form-control-sm rounded-pill @error('password') is-invalid @enderror"
                                            name="password" id="password" value="" autocomplete="new-password" required>
                                        @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                                        </span>
                                    ...
                                    <div class="mb-2 inner-addon left-addon">
                                        ...
                                        <input type="password" class="form-control form-control-sm rounded-pill"
                                            name="password-confirmation" id="password-repeat" value="" autocomplete="new-password" required>
                                    </div>
                                    <div class="vstack">
                                        <button type="submit"
                                            class="btn btn-primary shadow rounded-pill my-2">Register</button>
