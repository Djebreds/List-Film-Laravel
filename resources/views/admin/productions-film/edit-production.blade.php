...
@section('title', 'Update Data Production')
@section('content')
    <div class="hstack gap-4">
        ...
        <h2 class="m-0">Update Data Production</h2>
    </div>
    <div class="row">
        <div class="col">
                ...
                <div class="card-body">
                    @if(session('status'))
                        ...
                        <div class='alert alert-success d-flex alert-dismissible fade show' role='alert'>
                            ...
                            <div>
                                {{ session('status') }} <a href='{{ route('productions') }}' class='alert-link'>See
                                    for
                                    more</a>.
                            </div>
                    ...
                    @endif
                    <form action="{{ route('update-production', $productions->id_production) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="m-4">
                                        ...
                                        <div class="col-sm-11">
                                            <input type="text"
                                                   class="form-control form-control-sm @error('production') is-invalid @enderror"
                                                   name="name_production"
                                                   id="title" value="{{ $productions->name_production }}" required>
                                            @error('production')
                                    ...
                                    <div class="row m-4">
                                        ...
                                        <div class="col-6">
                                            <input type="date"
                                                   ...
                                                   name="founded_date"
                                                   id="dates" value="{{ $productions->founded_date }}" required>
                                            @error('founded_date')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
