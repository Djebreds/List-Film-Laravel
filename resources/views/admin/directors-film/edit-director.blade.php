...
@section('title', 'Update Data Director')
@section('content')
    <div class="hstack gap-4">
        ...
        <h2 class="m-0">Update Data Director</h2>
    </div>
    <div class="row">
        <div class="col">
            <div class="card mt-4 border border-4 border-end-0 border-top-1 border-bottom-0 border-start-0 border-info shadow  mb-2 bg-body rounded mx-auto"
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('update-director', $directors->id) }}" method="POST"
                            ...
                            <div class="col-3">
                                <div class="mb-3 pt-2">
                                    ...
                                    <input class="form-control form-control-sm @error('name_director') is-invalid @enderror"
                                           ...
                                           type="text" value="{{ $directors->name_director }}" required>
                                    @error('name_director')
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('about') is-invalid @enderror" id="about"
                                              name="about" rows="12"
                                              placeholder="about..."
                                              required>{{ $directors->about }}</textarea>
                                    @error('about')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
