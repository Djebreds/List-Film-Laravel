    ...
    <div id="mySidenav" class="sidenav">
        ...
        <div class="taks-list">
            <div class="list-item" id="list-item">
                ...
                <hr class="hr my-0">
                <div class="dashboard">
                    <a href="{{ url('/') }}" class="m-1 tables {{ Request::is('/') ? 'active' : '' }}"><svg
                ...
                <ul class="item-list">
                    <li>
                        <a href="{{ url('films') }}"
                            class="m-1 tables {{ Request::segment(1) === 'films' ? 'active' : '' }}"><svg
                    ...
                    <li>
                        <a href="{{ url('productions') }}"
                            class="m-1 tables {{ Request::segment(1) === 'productions' ? 'active' : '' }}"><svg
                                class="me-1" xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                    ...
                    <li>
                        <a href="{{ url('genres') }}"
                            class="m-1 tables {{ Request::segment(1) === 'genres' ? 'active' : '' }}"><svg
                                class="me-1" xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                    ...
                    <li>
                        <a href="{{ url('directors') }}"
                            class="m-1 tables {{ Request::segment(1) === 'directors' ? 'active' : '' }}"><svg
                                class="me-1" xmlns="http://www.w3.org/2000/svg" width="18" height="18"
